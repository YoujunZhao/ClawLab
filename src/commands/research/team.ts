...
const builtInSkills: BuiltInSkill[] = [
	...
	},
	{
		...
		name: 'Paper Outline',
		category: 'writing',
		summary: 'Build a section-by-section outline from verified artifacts.',
		recommendedRoles: ['paper_writer'],
		recommendedStages: ['publication'],
		triggers: ['outline', 'paper skeleton'],
	},
	{
		id: 'title-generation',
		name: 'Title Generation',
		category: 'writing',
		summary: 'Generate title candidates aligned with contribution and evidence scope.',
		recommendedRoles: ['paper_writer'],
		recommendedStages: ['publication'],
		triggers: ['title', 'paper title'],
	},
	{
		id: 'abstract-polish',
		name: 'Abstract Polish',
		category: 'writing',
		summary: 'Compress verified findings into a concise, non-overclaiming abstract.',
		recommendedRoles: ['paper_writer', 'reviewer'],
		recommendedStages: ['publication'],
		triggers: ['abstract', 'summary polish'],
	},
	{
		id: 'related-work-synthesis',
		name: 'Related Work Synthesis',
		category: 'writing',
		summary: 'Synthesize prior work and clearly position contribution boundaries.',
		recommendedRoles: ['paper_writer', 'literature_scout'],
		recommendedStages: ['publication'],
		triggers: ['related work', 'positioning'],
	},
	{
		id: 'method-writeup',
		name: 'Method Writeup',
		category: 'writing',
		summary: 'Write method section from implemented design and logged decisions.',
		recommendedRoles: ['paper_writer', 'experiment_driver'],
		recommendedStages: ['publication'],
		triggers: ['method section', 'algorithm writeup'],
	},
	{
		id: 'experiment-writeup',
		name: 'Experiment Writeup',
		category: 'writing',
		summary: 'Write experiments and ablations from run logs and metric snapshots only.',
		recommendedRoles: ['paper_writer', 'experiment_driver'],
		recommendedStages: ['publication'],
		triggers: ['experiment section', 'ablation writeup'],
	},
	{
		id: 'limitation-writing',
		name: 'Limitation Writing',
		category: 'writing',
		summary: 'Document unresolved issues, scope limits, and realistic future work.',
		recommendedRoles: ['paper_writer', 'reviewer'],
		recommendedStages: ['publication', 'promotion'],
		triggers: ['limitations', 'future work'],
	},
	{
		id: 'figure-caption-writing',
		name: 'Figure Caption Writing',
		category: 'writing',
		summary: 'Generate evidence-grounded figure and table captions.',
		recommendedRoles: ['paper_writer'],
		recommendedStages: ['publication', 'promotion'],
		triggers: ['caption', 'figure legend'],
	},
	{
	...
	},
	{
		...
		name: 'Review Parse',
		category: 'review',
		summary: 'Parse reviewer comments into structured concern units.',
		recommendedRoles: ['reviewer'],
		recommendedStages: ['publication'],
		triggers: ['review parse', 'review comments'],
	},
	{
		id: 'concern-decompose',
		name: 'Concern Decompose',
		category: 'review',
		summary: 'Split broad reviewer feedback into actionable concern atoms.',
		recommendedRoles: ['reviewer'],
		recommendedStages: ['publication'],
		triggers: ['concern split', 'decompose comment'],
	},
	{
		id: 'concern-typing',
		name: 'Concern Typing',
		category: 'review',
		summary: 'Assign concern types such as weak baseline, overclaiming, or clarity.',
		recommendedRoles: ['reviewer'],
		recommendedStages: ['publication'],
		triggers: ['concern type', 'classification'],
	},
	{
		id: 'rebuttal-strategy',
		name: 'Rebuttal Strategy',
		category: 'review',
		summary: 'Select direct answer, explanation update, or experiment-backed response.',
		recommendedRoles: ['reviewer', 'conductor'],
		recommendedStages: ['publication'],
		triggers: ['rebuttal strategy', 'response plan'],
	},
	{
		id: 'rebuttal-experiment-gap',
		name: 'Rebuttal Experiment Gap',
		category: 'review',
		summary: 'Detect which concerns require new experiments before a valid response.',
		recommendedRoles: ['reviewer', 'experiment_driver'],
		recommendedStages: ['publication', 'experiment'],
		triggers: ['missing experiment', 'ablation gap'],
	},
	{
		id: 'rebuttal-evidence-mapping',
		name: 'Rebuttal Evidence Mapping',
		category: 'review',
		summary: 'Map each concern to supporting runs, logs, figures, and sections.',
		recommendedRoles: ['reviewer', 'paper_writer'],
		recommendedStages: ['publication'],
		triggers: ['evidence map', 'concern mapping'],
	},
	{
		id: 'reviewer-response-writing',
		name: 'Reviewer Response Writing',
		category: 'writing',
		summary: 'Draft concise, evidence-grounded answers for each reviewer concern.',
		recommendedRoles: ['paper_writer', 'reviewer'],
		recommendedStages: ['publication'],
		triggers: ['review response', 'rebuttal draft'],
	},
	{
		id: 'point-by-point-response',
		name: 'Point-by-Point Response',
		category: 'writing',
		summary: 'Generate numbered point-by-point responses tied to concern IDs.',
		recommendedRoles: ['paper_writer', 'reviewer'],
		recommendedStages: ['publication'],
		triggers: ['point by point', 'numbered response'],
	},
	{
		id: 'revision-plan-writing',
		name: 'Revision Plan Writing',
		category: 'planning',
		summary: 'Write a revision plan with file-level edits and experiment deltas.',
		recommendedRoles: ['reviewer', 'conductor'],
		recommendedStages: ['publication', 'promotion'],
		triggers: ['revision plan', 'camera ready plan'],
	},
	{
